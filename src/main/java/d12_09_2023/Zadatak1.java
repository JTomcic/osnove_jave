...
// po ceni od (cena nekretnin) pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu od (zarada agencije)
        ...
        FizickoLice prodavac = new FizickoLice("Jovana Tomcic", 37324647, "4798473", true);
        FizickoLice kupac = new FizickoLice("Ivana Ivanovic", 37324656, "479856767", true);
        Ugovor ugovor = new Ugovor("22.09.2022." , prodavac, kupac, 500000, "FF 4, Kursumlija");
        ugovor.stampaj();
    }
}
